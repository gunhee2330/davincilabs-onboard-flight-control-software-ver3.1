 ...
 * C/C++ source code generated on : Thu Mar 12 15:22:57 2026
 *
...
/* Block states (default storage) for system '<S1997>/MATLAB Function' */
typedef struct {
  real_T hover_thrust;                 /* '<S1997>/MATLAB Function' */
...
typedef struct {
  ...
  DW_MATLABFunction_UAM_Fligh_p_T sf_MATLABFunction_mi;/* '<S1997>/MATLAB Function' */
