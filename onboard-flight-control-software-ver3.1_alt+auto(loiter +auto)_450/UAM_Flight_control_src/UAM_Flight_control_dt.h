 ...
 * C source code generated on : Wed Mar 11 20:16:40 2026
 *
...
static DataTypeTransition rtBTransitions[] = {
  ...
  { (char_T *)(&UAM_Flight_control_B.GPSCourse), 0, 0, 579 },
  ...
  { (char_T *)(&UAM_Flight_control_B.mode), 3, 0, 35 },

  { (char_T *)(&UAM_Flight_control_B.DataTypeConversion), 8, 0, 15 },

  { (char_T *)(&UAM_Flight_control_B.WaypointFollower_ni.LAP[0]), 0, 0, 3 },

  { (char_T *)(&UAM_Flight_control_B.WaypointFollower_n.LAP[0]), 0, 0, 3 }
  ,

  { (char_T *)(&UAM_Flight_control_DW.obj), 63, 0, 1 },

  { (char_T *)(&UAM_Flight_control_DW.obj_d), 60, 0, 1 },

  { (char_T *)(&UAM_Flight_control_DW.obj_l), 61, 0, 1 },

  { (char_T *)(&UAM_Flight_control_DW.obj_c), 62, 0, 1 },

  { (char_T *)(&UAM_Flight_control_DW.obj_j), 59, 0, 1 },

  { (char_T *)(&UAM_Flight_control_DW.obj_cg), 58, 0, 2 },
  ...
  { (char_T *)(&UAM_Flight_control_DW.UnitDelay6_DSTATE[0]), 0, 0, 730 },

  { (char_T *)(&UAM_Flight_control_DW.WAYPOINT_execBlock), 11, 0, 13 },

  { (char_T *)(&UAM_Flight_control_DW.UnitDelay_8_DSTATE), 27, 0, 3 },

  { (char_T *)(&UAM_Flight_control_DW.is_c1_UAM_Flight_control), 7, 0, 11 },
  ...
  { (char_T *)(&UAM_Flight_control_DW.DiscreteTimeIntegrator_DSTATE), 52, 0, 85
  },

  { (char_T *)(&UAM_Flight_control_DW.last_arm), 3, 0, 6 },

  { (char_T *)(&UAM_Flight_control_DW.locked), 8, 0, 17 },
  ...
  { (char_T *)(&UAM_Flight_control_DW.WaypointFollower_ni.obj), 60, 0, 1 },

  { (char_T *)(&UAM_Flight_control_DW.WaypointFollower_ni.objisempty), 8, 0, 1 },

  { (char_T *)(&UAM_Flight_control_DW.WaypointFollower_n.obj), 60, 0, 1 },

  { (char_T *)(&UAM_Flight_control_DW.WaypointFollower_n.objisempty), 8, 0, 1 },
  ...
  { (char_T *)(&UAM_Flight_control_DW.sf_MATLABFunction_ij.sfEvent), 6, 0, 1 },

  { (char_T *)
    (&UAM_Flight_control_DW.sf_MATLABFunction_ij.doneDoubleBufferReInit), 8, 0,
    1 },

  { (char_T *)(&UAM_Flight_control_DW.sf_MATLABFunction_ac.hover_thrust), 0, 0,
    1 },

  { (char_T *)(&UAM_Flight_control_DW.sf_MATLABFunction_ac.sfEvent), 6, 0, 1 },

  { (char_T *)
    (&UAM_Flight_control_DW.sf_MATLABFunction_ac.doneDoubleBufferReInit), 8, 0,
    2 },
  ...
  { (char_T *)(&UAM_Flight_control_DW.sf_MATLABFunction_l.sfEvent), 6, 0, 1 },

  { (char_T *)(&UAM_Flight_control_DW.sf_MATLABFunction_l.doneDoubleBufferReInit),
    8, 0, 1 },

  { (char_T *)(&UAM_Flight_control_DW.sf_MATLABFunction1.sfEvent), 6, 0, 1 },

  { (char_T *)(&UAM_Flight_control_DW.sf_MATLABFunction1.doneDoubleBufferReInit),
    8, 0, 1 },
  ...
  { (char_T *)(&UAM_Flight_control_DW.sf_MATLABFunction_i.sfEvent), 6, 0, 1 },

  { (char_T *)(&UAM_Flight_control_DW.sf_MATLABFunction_i.doneDoubleBufferReInit),
    8, 0, 1 },

  { (char_T *)(&UAM_Flight_control_DW.sf_MATLABFunction_mi.hover_thrust), 0, 0,
    1 },

  { (char_T *)(&UAM_Flight_control_DW.sf_MATLABFunction_mi.sfEvent), 6, 0, 1 },

  { (char_T *)
    (&UAM_Flight_control_DW.sf_MATLABFunction_mi.doneDoubleBufferReInit), 8, 0,
    2 },
...
static DataTypeTransition rtPTransitions[] = {
  ...
  { (char_T *)(&UAM_Flight_control_P.PitchAngleController_InitialCon), 0, 0, 131
  },
  ...
  { (char_T *)(&UAM_Flight_control_P.UnitDelay_6_InitialCondition_d), 25, 0, 1 },
  ...
  { (char_T *)(&UAM_Flight_control_P.UnitDelay_7_InitialCondition_d), 26, 0, 1 },
  ...
  { (char_T *)(&UAM_Flight_control_P.MixerCommands_Y0_o), 53, 0, 1 },
  ...
  { (char_T *)(&UAM_Flight_control_P.UnitDelay_5_InitialCondition_d), 24, 0, 1 },
  ...
  { (char_T *)(&UAM_Flight_control_P.CtrlSurfaceCommands_Y0_h), 35, 0, 1 },

  { (char_T *)(&UAM_Flight_control_P.Merge_InitialOutput_m), 35, 0, 1 },

  { (char_T *)(&UAM_Flight_control_P.CtrlSurfaceCommands_Y0_k), 35, 0, 1 },

  { (char_T *)(&UAM_Flight_control_P.Merge_InitialOutput_g), 35, 0, 1 },

  { (char_T *)(&UAM_Flight_control_P.Merge_68_InitialOutput), 35, 0, 1 },

  { (char_T *)(&UAM_Flight_control_P.Actuator_Y0), 35, 0, 1 },

  { (char_T *)(&UAM_Flight_control_P.Actuator_Y0_a), 35, 0, 1 },

  { (char_T *)(&UAM_Flight_control_P.AER_Y0), 0, 0, 542 },

  { (char_T *)(&UAM_Flight_control_P.Constant_Value_n), 27, 0, 10 },
  ...
  { (char_T *)(&UAM_Flight_control_P.Constant_Value_jf), 2, 0, 52 },

  { (char_T *)(&UAM_Flight_control_P.Gain_Gain_ck), 50, 0, 30 },
  ...
  { (char_T *)
    (&UAM_Flight_control_P.SwitchCaseActionSubsystem2_m.Saturation2_UpperSat), 0,
    0, 6 },

  { (char_T *)(&UAM_Flight_control_P.SwitchCaseActionSubsystem3_e.Constant_Value),
    0, 0, 4 },

  { (char_T *)(&UAM_Flight_control_P.SwitchCaseActionSubsystem_g.Constant_Value),
    0, 0, 4 },
